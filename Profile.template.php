...
function template_summary()
{
	...
	$group_color = empty($context['member']['group_color']) ? 'inherit' : $context['member']['group_color'];
	$post_group_color = empty($context['member']['post_group_color']) ? 'inherit' : $context['member']['post_group_color'];
	...
	<div id="basicinfo">
		<div class="windowbg">
			...
			<div class="content flow_auto">
				', !empty($context['member']['avatar']['href']) ? '<img src="'.$context['member']['avatar']['href'].'" alt="" class="avatar">' : $settings['sr_default_avatar'], '
				<div class="admCon">
				<div class="username"><h4><span class="actualName">', $context['member']['name'], '</span><span class="position">', (!empty($context['member']['group']) ? '<span style="color:'.$group_color.'">'.$context['member']['group'].'<span>' : '<span style="color:'.$post_group_color.'">'.$context['member']['post_group'].'</span>'), '</span></h4></div>';
//			<div class="username"><h4>', $context['member']['name'], ' <span class="position">', (!empty($context['member']['group']) ? $context['member']['group'] : $context['member']['post_group']), '</span></h4></div>
	...
	if ($context['member']['show_email'] === 'yes' || $context['member']['show_email'] === 'no_through_forum' || $context['member']['show_email'] === 'yes_permission_override')
		echo '
					<li><a class="tooltip" href="', $scripturl, '?action=emailuser;sa=email;uid=', $context['member']['id'], '" title="', $context['member']['show_email'] == 'yes' || $context['member']['show_email'] == 'yes_permission_override' ? $context['member']['email'] : '', '" rel="nofollow"><img src="', $settings['images_url'], '/email_sm.gif" alt="', $txt['email'], '" /></a></li>';

	// Don't show an icon if they haven't specified a website.
	if ($context['member']['website']['url'] !== '' && !isset($context['disabled_fields']['website']))
		echo '
					<li><a href="', $context['member']['website']['url'], '" title="' . $context['member']['website']['title'] . '" target="_blank" class="tooltip new_win">', ($settings['use_image_buttons'] ? '<img src="' . $settings['images_url'] . '/www_sm.gif" alt="' . $context['member']['website']['title'] . '" />' : $txt['www']), '</a></li>';
	...
	if (!empty($context['can_have_buddy']) && !$context['user']['is_owner'])
		echo '
				<a href="', $scripturl, '?action=buddy;u=', $context['id_member'], ';', $context['session_var'], '=', $context['session_id'], '">', $txt['buddy_' . ($context['member']['is_buddy'] ? 'remove' : 'add')], '</a><br/>';
