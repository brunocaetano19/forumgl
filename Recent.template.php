...
function template_unread()
{
	...
	if (!empty($context['topics']))
	{
				...
				<table class="table_grid" cellspacing="0">
					<thead>
						<tr class="catbg">
							...
							<th scope="col" width="14%" align="center" class="taphoNone">
		...
		if ($showCheckboxes)
			echo '
							<th scope="col" width="22%" class="phoneNone eightSixtyRemove">
							...
							<th class="last_th phoneNone">
								<input type="checkbox" onclick="invertAll(this, this.form, \'topics[]\');" class="input_check" />
							</th>';
		else
			echo '
							<th scope="col" class="smalltext last_th eightSixtyRemove phoneNone" width="22%">
								<a href="', $scripturl, '?action=unread', $context['showing_all_topics'] ? ';all' : '', $context['querystring_board_limits'], ';sort=last_post', $context['sort_by'] == 'last_post' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $txt['last_post'], $context['sort_by'] == 'last_post' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a>
							</th>';
		echo '
						</tr>
		...
		foreach ($context['topics'] as $topic)
		{
			...
			$color_class = '';
			if (strpos($topic['class'], 'sticky') !== false && strpos($topic['class'], 'locked') !== false)
				$color_class = 'locked_sticky';
			elseif (strpos($topic['class'], 'sticky') !== false)
				$color_class = 'stickybg';
			elseif (strpos($topic['class'], 'locked') !== false)
            ...
            echo '
							...
							<td class="', $color_class, ' stats windowbg taphoNone">
								', $topic['replies'], ' ', $txt['replies'], '
								<br />
								', $topic['views'], ' ', $txt['views'], '
							</td>
							<td class="', $color_class2, ' lastpost eightSixtyRemove windowbg2 phoneNone">
			...
			if ($showCheckboxes)
				echo '
							<td class="windowbg2 phoneNone" valign="middle" align="center">
		...
		echo '
				<div class="pagelinks floatleft" style="width: auto;">', $txt['pages'], ': ', $context['page_index'], '</div>
			</div>';
	}
	else
		echo '
			<div class="description tsized" align="center">
...
function template_replies()
{
	...
	if (!empty($context['topics']))
	{
		...
		if ($showCheckboxes)
			...
			echo '
							<th scope="col" class="last_th phoneNone" width="22%">
								<a href="', $scripturl, '?action=unreadreplies', $context['querystring_board_limits'], ';sort=last_post', $context['sort_by'] === 'last_post' && $context['sort_direction'] === 'up' ? ';desc' : '', '">', $txt['last_post'], $context['sort_by'] === 'last_post' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a>
							</th>';
		echo '
						</tr>
